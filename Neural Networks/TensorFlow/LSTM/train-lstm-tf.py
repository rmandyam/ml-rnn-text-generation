...
Usage : train-lstm-tf.py to train a model
      : train-lstm-tf.py  --r RESTORE  to restore a trained model from an epoch and generate text
"""
...
from lstm_tf import Config
from lstm_tf import LSTMModel
