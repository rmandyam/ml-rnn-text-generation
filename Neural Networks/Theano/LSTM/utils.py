...
def load_data(filename="../../data/input.txt", vocabulary_size=2000, min_sent_characters=0):
...
#####################################
    ...
    for i, line in enumerate(open(filename)):
          line = line.strip()
          #TODO : do we need this line below ? yes, we need it..
          line = line.replace('.', ' . ')
	  #TODO : should we convert to lower case to be consistent with the other examples from WildML ??
